        ...
        return (
            <p className='signup-body-message-subtitle'>
                {formatMessage({
                    ...
                    defaultMessage: 'Create your Tam Dev account to start collaborating with your team',
                })}
            </p>
        );
    };
        ...
        if (canReachCWS) {
            return (
                <CheckInput
                    ...
                    text={
                        formatMessage(
                            {id: 'newsletter_optin.checkmark.text', defaultMessage: '<span>I would like to receive Tam Dev security updates via newsletter.</span> By subscribing, I consent to receive emails from Tam Dev with product updates, promotions, and company news. I have read the <a>Privacy Policy</a> and understand that I can <aa>unsubscribe</aa> at any time'},
                            {
        ...
        return (
            <div className='newsletter'>
                <span className='interested'>
                    {formatMessage({id: 'newsletter_optin.title', defaultMessage: 'Interested in receiving Tam Dev security, product, promotions, and company updates updates via newsletter?'})}
                </span>
                <span className='link'>
                    {formatMessage(
