...
const CustomTermsOfServiceFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Create custom terms of service with Tam Dev Enterprise'
            copyID='admin.custom_terms_of_service_feature_discovery.copy'
            copyDefault={'Create your own terms of service that new users must accept before accessing your Tam Dev instance on desktop, web, or mobile.'}
