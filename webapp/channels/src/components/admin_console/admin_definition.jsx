    ...
    about: {
        ...
        license: {
            ...
            searchableStrings: [
                ...
                'admin.license.type',
                'admin.license.key',
                'Tam Dev Enterprise Edition. Unlock enterprise features in this software through the purchase of a subscription from ',
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The URL that users will use to access Tam Dev. Standard ports, such as 80 and 443, can be omitted, but non-standard ports are required. For example: http://example.com:8065. This setting is required.\n \nMattermost may be hosted at a subpath. For example: http://example.com:8065/company/mattermost. A restart is required before the server will work correctly.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'A comma-separated list of paths on the Tam Dev server that are managed by another service. See <link>here</link> for more information.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Deployments using multiple databases can switch from one master database to another without restarting the Tam Dev server by updating "config.json" to the new desired configuration and using the {featureName} feature to load the new settings while the server is running. The administrator should then use the {recycleDatabaseConnections} feature to recycle the database connections based on the new settings.',
                        help_text_values: {
                            featureName: (
                                <b>
                                    <FormattedMessage
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'AWS region you selected when creating your S3 bucket. If no region is set, Tam Dev attempts to get the appropriate region from AWS, or sets it to "us-east-1" if none found.',
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will not verify the email server certificate.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.SMTP)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The location of the log files. If blank, they are stored in the ./logs directory. The path that you set must exist and Tam Dev must have write permissions in it. Changing this setting requires a server restart before taking effect.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enable this feature to improve the quality and performance of Tam Dev by sending error reporting and diagnostic information to Tam Dev, Inc. Read our <link>privacy policy</link> to learn more.',
                        help_text_markdown: false,
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will enable performance monitoring collection and profiling. Please see <link>documentation</link> to learn more about configuring performance monitoring for Tam Dev.',
                        help_text_markdown: false,
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'A whitelist of local network addresses that can be requested by the Tam Dev server on behalf of a client. Care should be used when configuring this setting to prevent unintended access to your local network. See <link>documentation</link> to learn more. Changing this requires a server restart before taking effect.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'Name of service shown in login screens and UI. When not specified, it defaults to "Tam Dev".',
                        placeholder: t('admin.team.siteNameExample'),
                        placeholder_default: 'E.g.: "Tam Dev"',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, "Ask the community" link appears on the Tam Dev user interface and Help Menu, which allows users to join the Tam Dev Community to ask questions and help others troubleshoot issues. When false, the link is hidden from users.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        ...
                        help_text_default: 'The URL for the Help link on the Tam Dev login page, sign-up pages, and Help Menu. If this field is empty, the Help link is hidden from users.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        ...
                        help_text_default: 'Link to the terms under which users may use your online service. By default, this includes the "Tam Dev Conditions of Use (End Users)" explaining the terms under which Tam Dev software is provided to end users. If you change the default link to add your own terms for using the service you provide, your new terms must include a link to the default terms so end users are aware of the Tam Dev Conditions of Use (End User) for Tam Dev software.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The URL for the About link on the Tam Dev login and sign-up pages. If this field is empty, the About link is hidden from users.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                    },
                    {
                        ...
                        help_text_default: 'The URL for the Forgot Password link on the Tam Dev login page. If this field is empty the Forgot Password link takes users to the Password Reset page.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        label_default: 'Tam Dev Apps Download Page Link:',
                        help_text: t('admin.customization.appDownloadLinkDesc'),
                        help_text_default: 'Add a link to a download page for the Tam Dev apps. When a link is present, an option to "Download Tam Dev Apps" will be added in the Product Menu so users can find the download page. Leave this field blank to hide the option from the Product Menu.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                    },
                    {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Typically set to true in production. When true, Tam Dev attempts to send email notifications. When false, email invitations and user account setting change emails are still sent as long as the SMTP server is configured. Developers may set this field to false to skip email setup for faster development.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTIFICATIONS)),
                        isHidden: it.licensedForFeature('Cloud'),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        placeholder_default: 'Ex: "Tam Dev Notification", "System", "No-Reply"',
                        help_text: t('admin.environment.notifications.notificationDisplay.help'),
                        help_text_default: 'Display name on email account used when sending notification emails from Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTIFICATIONS)),
                            it.stateIsFalse('EmailSettings.SendEmailNotifications'),
                        ),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Email address displayed on email account used when sending notification emails from Tam Dev.',
                        isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTIFICATIONS)),
                            it.stateIsFalse('EmailSettings.SendEmailNotifications'),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Email address used in the Reply-To header when sending notification emails from Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTIFICATIONS)),
                            it.stateIsFalse('EmailSettings.SendEmailNotifications'),
                        ),
                    },
                    {
                        ...
                        help_text_default: 'Organization name and address displayed on email notifications from Tam Dev, such as "© ABC Corporation, 565 Knight Way, Palo Alto, California, 94305, USA". If the field is left empty, the organization name and address will not be displayed.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTIFICATIONS)),
                            it.stateIsFalse('EmailSettings.SendEmailNotifications'),
                        ),
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When enabled, links to Tam Dev messages will generate a preview for any users that have access to the original message. Please review our <link>documentation</link> for details.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, Tam Dev allows account creation using email and password. This value should be false only when you want to limit sign up to a single sign-on service like AD/LDAP, SAML or GitLab.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Typically set to true in production. When true, Tam Dev requires email verification after account creation prior to allowing login. Developers may set this field to false to skip sending verification emails for faster development.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.EMAIL)),
                        isHidden: it.licensedForFeature('Cloud'),
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev allows users to sign in using their email and password.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.EMAIL)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
                        ...
                        settings: [
                            {
                                ...
                                help_text_default: 'When true, Tam Dev allows login using AD/LDAP',
                            ...
                            },
                            {
                                ...
                                help_text_default: 'When true, Tam Dev periodically synchronizes users from AD/LDAP. When false, user attributes are updated from AD/LDAP during user login only.',
                                isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                            },
                            {
                                type: Constants.SettingsTypes.TYPE_TEXT,
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The port Tam Dev will use to connect to the AD/LDAP server. Default is 389.',
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The username used to perform the AD/LDAP search. This should typically be an account created specifically for use with Tam Dev. It should have access limited to read the portion of the AD/LDAP tree specified in the Base DN field.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                        ...
                        settings: [
                            {
                                ...
                                help_text_default: 'The Base DN is the Distinguished Name of the location where Tam Dev should start its search for user and group objects in the AD/LDAP tree.',
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) Enter an AD/LDAP filter to use when searching for user objects. Only the users selected by the query will be able to access Tam Dev. For Active Directory, the query to filter out disabled users is (&(objectCategory=Person)(!(UserAccountControl:1.2.840.113556.1.4.803:=2))).',
                            ...
                            },
                            {
                                ...
                                help_text_markdown: true,
                                help_text_default: '(Optional) Enter an AD/LDAP filter to use when searching for group objects. Only the groups selected by the query will be available to Tam Dev. From [User Management > Groups]({siteURL}/admin_console/user_management/groups), select which AD/LDAP groups should be linked and configured.',
                        ...
                        settings: [
                            {
                                ...
                                help_text_markdown: false,
                                help_text_default: 'The attribute in the AD/LDAP server used as a unique identifier in Tam Dev. It should be an AD/LDAP attribute with a value that does not change such as `uid` for LDAP or `objectGUID` for Active Directory. If a user\'s ID Attribute changes, it will create a new Tam Dev account unassociated with their old one.\n \nIf you need to change this field after users have already logged in, use the <link>mattermost ldap idmigrate</link> CLI tool.',
                                help_text_values: {
                                    link: (msg) => (
                                        <ExternalLink
                                            location='admin_console'
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The attribute in the AD/LDAP server used to populate the username field in Tam Dev. This may be the same as the Login ID Attribute.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The attribute in the AD/LDAP server used to populate the email address field in Tam Dev.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the first name of users in Tam Dev. When set, users cannot edit their first name, since it is synchronized with the LDAP server. When left blank, users can set their first name in <strong>Account Menu > Account Settings > Profile</strong>.',
                                help_text_values: {
                                    strong: (msg) => <strong>{msg}</strong>,
                                },
                                isDisabled: it.any(
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the last name of users in Tam Dev. When set, users cannot edit their last name, since it is synchronized with the LDAP server. When left blank, users can set their last name in <strong>Account Menu > Account Settings > Profile</strong>.',
                                help_text_values: {
                                    strong: (msg) => <strong>{msg}</strong>,
                                },
                                isDisabled: it.any(
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the nickname of users in Tam Dev. When set, users cannot edit their nickname, since it is synchronized with the LDAP server. When left blank, users can set their nickname in <strong>Account Menu > Account Settings > Profile</strong>.',
                                help_text_values: {
                                    strong: (msg) => <strong>{msg}</strong>,
                                },
                                isDisabled: it.any(
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the position field in Tam Dev. When set, users cannot edit their position, since it is synchronized with the LDAP server. When left blank, users can set their position in <strong>Account Menu > Account Settings > Profile</strong>.',
                                help_text_values: {
                                    strong: (msg) => <strong>{msg}</strong>,
                                },
                                isDisabled: it.any(
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The attribute in the AD/LDAP server used to populate the profile picture in Tam Dev.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                        ...
                        settings: [
                            {
                                ...
                                help_text_default: 'AD/LDAP Synchronization updates Tam Dev user information to reflect updates on the AD/LDAP server. For example, when a user\'s name changes on the AD/LDAP server, the change updates in Tam Dev when synchronization is performed. Accounts removed from or disabled in the AD/LDAP server have their Tam Dev accounts set to "Inactive" and have their account sessions revoked. Tam Dev performs synchronization on the interval entered. For example, if 60 is entered, Tam Dev synchronizes every 60 minutes.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: 'The maximum number of users the Tam Dev server will request from the AD/LDAP server at one time. 0 is unlimited.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: 'Tests if the Tam Dev server can connect to the AD/LDAP server specified. Please review "System Console > Logs" and <link>documentation</link> to troubleshoot errors.',
                                help_text_values: {
                                    link: (msg) => (
                                        <ExternalLink
                                            location='admin_console'
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, Tam Dev allows login using SAML 2.0. Please see <link>documentation</link> to learn more about configuring SAML for Tam Dev.',
                        help_text_markdown: false,
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev periodically synchronizes SAML user attributes, including user deactivation and removal, from AD/LDAP. Enable and configure synchronization settings at <strong>Authentication > AD/LDAP</strong>. When false, user attributes are updated from SAML during user login. See <link>documentation</link> to learn more.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will ignore Guest Users who are identified by the Guest Attribute, when synchronizing with AD/LDAP for user deactivation and removal and Guest deactivation will need to be managed manually via System Console > Users.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.configIsFalse('GuestAccountsSettings', 'Enable'),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The URL where Tam Dev sends a SAML request to start login sequence.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When false, Tam Dev will not verify that the signature sent from a SAML Response matches the Service Provider Login URL. Disabling verification is not recommended for production environments.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When false, Tam Dev will not decrypt SAML Assertions encrypted with your Service Provider Public Certificate. Disabling encryption is not recommended for production environments.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Tam Dev is the Service Provider.',
                        remove_help_text: t('admin.saml.publicCertificateFileRemoveDesc'),
                        remove_help_text_default: 'Remove the certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Tam Dev is the Service Provider.',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will sign the SAML request using your private key. When false, Tam Dev will not sign the SAML request.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Encrypt'),
                    ...
                    },
                    {
                        ...
                        help_text_default: 'The attribute in the SAML Assertion that will be used to populate the email addresses of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: 'The attribute in the SAML Assertion that will be used to populate the username field in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to bind users from SAML to users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    ...
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion for designating System Admins. The users selected by the query will have access to your Tam Dev server as System Admins. By default, System Admins have complete access to the Tam Dev System Console.\n \nExisting members that are identified by this attribute will be promoted from member to System Admin upon next login. The next login is based upon Session lengths set in **System Console > Session Lengths.** It is highly recommend to manually demote users to members in **System Console > User Management** to ensure access is restricted immediately.\n \nNote: If this filter is removed/changed, System Admins that were promoted via this filter will be demoted to members and will not retain access to the System Console. When this filter is not in use, System Admins can be manually promoted/demoted in **System Console > User Management**.',
                        help_text_markdown: true,
                        isDisabled: it.any(
                            it.not(it.isSystemAdmin),
                    ...
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to populate the first name of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to populate the last name of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to populate the nickname of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to populate the position of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
                    },
                    {
                        ...
                        help_text_default: '(Optional) The attribute in the SAML Assertion that will be used to populate the language of users in Tam Dev.',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.SAML)),
                            it.stateIsFalse('SamlSettings.Enable'),
                        ),
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, the "guest" tag will not be shown next to the name of all guest users in the Tam Dev chat interface.',
                        help_text_markdown: false,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.GUEST_ACCESS)),
                    },
                    {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev can act as an OAuth 2.0 service provider allowing Tam Dev to authorize API requests from external applications. See <link>documentation</link> to learn more.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev allows compliance reporting from the <strong>Compliance and Auditing</strong> tab. See <link>documentation</link> to learn more.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will generate a daily compliance report.',
                        isHidden: it.not(it.licensedForFeature('Compliance')),
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.COMPLIANCE.COMPLIANCE_MONITORING)),
                            it.stateIsFalse('ComplianceSettings.Enable'),
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enables client-side certification for your Tam Dev server. See <link>documentation</link> to learn more.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enables a hardened mode for Tam Dev that makes user experience trade-offs in the interest of security. See <link>documentation</link> to learn more.',
                        help_text_values: {
                            link: (msg) => (
                                <ExternalLink
                                    location='admin_console'
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, users are prompted with a tutorial when they open Tam Dev for the first time after account creation. When false, the tutorial is disabled, and users are placed in Town Square when they open Tam Dev for the first time after account creation.',
                        help_text_markdown: false,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.EXPERIMENTAL.FEATURES)),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        help_text_default: 'This setting defines the number of seconds after which the user’s status indicator changes to "Away", when they are away from Tam Dev.',
                        help_text_markdown: false,
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Tam Dev will not refetch channels and channel members when the browser regains focus. This may result in improved performance for users with many channels and channel members.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.EXPERIMENTAL.FEATURES)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
