        ...
        >
            ...
            <div className='start-trial-email-disclaimer'>
                <FormattedMessage
                    ...
                    defaultMessage='By selecting <highlight>“Start trial”</highlight>, I agree to the <linkEvaluation>Tam Dev Software and Services License Agreement</linkEvaluation>, <linkPrivacy>privacy policy</linkPrivacy> and receiving product emails.'
                    values={{
