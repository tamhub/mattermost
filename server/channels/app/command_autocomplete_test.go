...
func TestSuggestions(t *testing.T) {
	...
	assert.Equal(t, "Connect your Tam Dev account to your Jira account", suggestions[0].Description)
...
func createJiraAutocompleteData() *model.AutocompleteData {
	...
	connect := model.NewAutocompleteData("connect", "[url]", "Connect your Tam Dev account to your Jira account")
	jira.AddCommand(connect)

	disconnect := model.NewAutocompleteData("disconnect", "", "Disconnect your Tam Dev account from your Jira account")
	...
	install := model.NewAutocompleteData("install", "", "Connect Tam Dev to a Jira instance")
	...
	uninstall := model.NewAutocompleteData("uninstall", "", "Disconnect Tam Dev from a Jira instance")
