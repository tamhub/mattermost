...
const baseManifestJSON = `{
  ...
  "display": "standalone",
  "start_url": ".",
  "description": "Tam Dev is an open source, self-hosted Slack-alternative",
