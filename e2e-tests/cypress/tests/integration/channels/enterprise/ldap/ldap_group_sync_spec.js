...
context('ldap', () => {
    ...
    describe('LDAP Group Sync Automated Tests', () => {
        ...
        it('MM-T1537 - Sync Group Removal from Channel Configuration Page', () => {
            ...
            cy.get('.admin-console__header', {timeout: TIMEOUTS.ONE_MIN}).should('be.visible').and('have.text', 'Tam Dev Channels');
        ...
        it('MM-T2618 - Team Configuration Page: Group removal User removed from sync\'ed team', () => {
            ...
            cy.get('.admin-console__header', {timeout: TIMEOUTS.ONE_MIN}).should('be.visible').and('have.text', 'Tam Dev Teams');
